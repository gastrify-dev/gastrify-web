...
import { useUpdateIdentificationNumberForm } from "@/features/settings/hooks/use-update-identification-number-form";

export function UpdateIdentificationNumberForm() {
  const {
    form,
    canSubmit,
    onSubmit,
    ...
    isSessionRefetching,
    t,
  } = useUpdateIdentificationNumberForm();
